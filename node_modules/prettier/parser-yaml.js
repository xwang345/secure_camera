!(function(e, t) {
      ...
      return (
        s(e, null, [
          ...
          },
          {
            ...
            value: function(e, t, n) {
              ...
              if (n) {
                if (r !== n) return !1;
              } else if (r !== u.DIRECTIVES_END && r !== u.DOCUMENT_END)
                return !1;
              var o = e[t + 1],
                i = e[t + 2];
              if (o !== r || i !== r) return !1;
        ...
        s(e, [
          ...
          },
          {
            ...
            get: function() {
              for (var e = 0; e < this.props.length; ++e) {
                var t = this.getPropValue(e, u.ANCHOR, !0);
                if (null != t) return t;
              }
              return null;
            }
          },
          {
            ...
            get: function() {
              for (var e = [], t = 0; t < this.props.length; ++t) {
                var n = this.getPropValue(t, u.COMMENT, !0);
                null != n && e.push(n);
              }
            ...
            get: function() {
              if (this.context)
                for (
                  ...
                  if (e[this.props[t].start] === u.COMMENT) return !0;
              return !1;
            }
          },
          {
          ...
          },
          {
            ...
            get: function() {
              for (var e = 0; e < this.props.length; ++e) {
                var t = this.getPropValue(e, u.TAG, !1);
                if (null != t) {
  ...
  var S = r(function(e, t) {
    ...
    var a = (function(e) {
      function t(e, n) {
        ...
        return (
          ((a = p(this, c(t).call(this))).name = "YAMLReferenceError"),
          (a.message = n),
          (a.source = e),
          a
        );
      }
      return u(t, d(ReferenceError)), t;
    })();
    ...
    var i = (function(e) {
      function t(e, n) {
        ...
        return (
          ((a = p(this, c(t).call(this))).name = "YAMLSemanticError"),
          (a.message = n),
          (a.source = e),
          a
        );
      }
      return u(t, d(SyntaxError)), t;
    })();
    ...
    var s = (function(e) {
      function t(e, n) {
        ...
        return (
          ((a = p(this, c(t).call(this))).name = "YAMLSyntaxError"),
          (a.message = n),
          (a.source = e),
          a
        );
    ...
    var f = (function(e) {
      function t(e, n) {
        ...
        return (
          ((a = p(this, c(t).call(this))).name = "YAMLWarning"),
          (a.message = n),
          (a.source = e),
          a
        );
      }
      return u(t, d(Error)), t;
    })();
    t.YAMLWarning = f;
  });
  n(S);
  var A = r(function(e, t) {
    ...
    var i = (function(e) {
      function t() {
        return o(this, t), p(this, c(t).call(this, r.Type.COMMENT));
      }
      return (
        u(t, r.default),
        s(t, [
  ...
  var P = r(function(e, t) {
    ...
    var i = (function(e) {
      function t() {
        ...
        return (
          o(this, t),
          ((e = p(this, c(t).call(this, r.Type.DIRECTIVE))).name = null),
          e
        );
      }
      return (
  ...
  var T = r(function(e, t) {
    ...
    var l = (function(e) {
      function t() {
        ...
        return (
          o(this, t),
          ((e = p(this, c(t).call(this, a.Type.DOCUMENT))).directives = null),
          (e.contents = null),
          e
        );
      }
        ...
        s(t, [
          {
            ...
            value: function(e) {
              ...
              for (
                var i = !1, s = e;
                !a.default.atDocumentBoundary(o, s, a.Char.DIRECTIVES_END);

              )
                switch (o[(s = t.startCommentOrEndBlankLine(o, s))]) {
                  case "\n":
                    s += 1;
                    break;
                  case "#":
                    var u = new n.default();
                    (s = u.parse({ src: o }, s)), this.directives.push(u);
                    break;
                  case "%":
                    var c = new r.default();
                    (s = c.parse({ parent: this, src: o }, s)),
          ...
          },
          {
            ...
            value: function(e) {
              ...
              for (var u = e; "-" === s[u - 1]; ) u -= 1;
              var c = a.default.endOfWhiteSpace(s, e),
                f = u === e;
              for (
                this.valueRange = new i.default(c);
                !a.default.atDocumentBoundary(s, c, a.Char.DOCUMENT_END);
                ...
                switch (s[c]) {
                  ...
                  case "#":
                    var l = new n.default();
                    (c = l.parse({ src: s }, c)), this.contents.push(l);
                    break;
                  default:
                    var d = a.default.endOfIndent(s, c),
                      h = o(
                        {
                          atLineStart: f,
                          indent: -1,
                    ...
                    this.contents.push(h), (c = h.range.end), (f = !1);
                }
                c = t.startCommentOrEndBlankLine(s, c);
              }
              if (((this.valueRange.end = c), s[c] && s[(c += 3)])) {
                if ("#" === s[(c = a.default.endOfWhiteSpace(s, c))]) {
                  var p = new n.default();
                  (c = p.parse({ src: s }, c)), this.contents.push(p);
                }
                switch (s[c]) {
                  case "\n":
                    c += 1;
          ...
          },
          {
            ...
            value: function(e, n) {
              return (
                (n = v(c(t.prototype), "setOrigRanges", this).call(this, e, n)),
  ...
  var L = r(function(e, t) {
    ...
    var i = (function(e) {
      function t() {
        return o(this, t), p(this, c(t).apply(this, arguments));
      }
      return (
        u(t, n.default),
        s(t, [
  ...
  var k = r(function(e, t) {
    ...
    var f = (function(e) {
      function t(e, n) {
        ...
        return (
          o(this, t),
          ((r = p(this, c(t).call(this, e, n))).blockIndent = null),
          (r.chomping = i.CLIP),
          (r.header = null),
          r
        );
            ...
            value: function(e) {
              for (
                var t = this.context,
                  ...
                  o = (t.inFlow, t.src),
                  i = e,
                  s = this.blockIndent ? n + this.blockIndent - 1 : n,
                  u = 1,
                  c = o[i];
                "\n" === c && ((i += 1), !r.default.atDocumentBoundary(o, i));
                c = o[i]
              ) {
                var f = r.default.endOfBlockIndent(o, s, i);
                if (null === f) break;
                if (!this.blockIndent) {
                  var l = f - (i + n);
                  if ("\n" !== o[f]) {
                    ...
                    (this.blockIndent = l), (s = n + this.blockIndent - 1);
                  } else l > u && (u = l);
                }
                i = r.default.endOfLine(o, f);
              }
          ...
          },
          {
            ...
            get: function() {
              ...
              for (
                ...
                for (var y = 0; y < l && " " === s[g]; ++y) g += 1;
                var _ = s[g];
                if ("\n" === _) "\n" === v ? (p += "\n") : (v = "\n");
                else {
                  var b = r.default.endOfLine(s, g),
                    w = s.slice(g, b);
                  (g = b),
                    d && (" " === _ || "\t" === _) && g < f
                      ? (" " === v
  ...
  var C = r(function(e, t) {
    ...
    var i = (function(e) {
      function t(e, n) {
        var r;
        return (
          o(this, t), ((r = p(this, c(t).call(this, e, n))).node = null), r
        );
      }
      return (
        u(t, r.default),
        s(t, [
          {
            ...
            value: function(e, t) {
              ...
              for (
                var u = i ? t - s : e.indent,
                  c = r.default.endOfWhiteSpace(o, t + 1),
                  f = o[c];
                "\n" === f || "#" === f;
                ...
                if ("#" === f) {
                  ...
                  this.props.push(new a.default(c, d)), (c = d);
                } else (i = !0), (s = l), (c = r.default.endOfWhiteSpace(o, l));
                f = o[c];
              }
              ...
              return (this.valueRange = new a.default(t, h)), c;
            }
          },
          {
            key: "setOrigRanges",
        ...
        s(t, [
          {
            ...
            value: function(e, t) {
              ...
              var o = e.parseNode,
                i = e.src,
                s = r.default.startOfLine(i, t),
                u = this.items[0];
              (u.context.parent = this),
                (this.valueRange = a.default.copy(u.valueRange));
              for (
                var c = u.range.start - u.context.lineStart,
                  f = t,
                  l = i[(f = r.default.normalizeOffset(i, f))],
                  d = r.default.endOfWhiteSpace(i, s) === f;
                l;
                ...
                for (; "\n" === l || "#" === l; ) {
                  ...
                  if (
                    ((s = f + 1),
                    (f = r.default.endOfIndent(i, s)),
                    r.default.atBlank(i, f))
                  ) {
                    var p = r.default.endOfWhiteSpace(i, f),
                      v = i[p];
                    (v && "\n" !== v && "#" !== v) || (f = p);
                  }
                  (l = i[f]), (d = !0);
                ...
                if (
                  ...
                  (d = !1),
                  (l = i[(f = r.default.normalizeOffset(i, y.range.end))]) &&
                    "\n" !== l &&
                    "#" !== l)
                ) {
                  for (var _ = f - 1, b = i[_]; " " === b || "\t" === b; )
                    b = i[--_];
                  "\n" === b && ((s = _ + 1), (d = !0));
                }
              }
  ...
  var R = r(function(e, t) {
    ...
    var f = (function(e) {
      function t(e, n) {
        var r;
        return (
          o(this, t), ((r = p(this, c(t).call(this, e, n))).items = null), r
        );
      }
      return (
        u(t, r.default),
            ...
            value: function(e, t) {
              ...
              for (c = i[f]; c && "]" !== c && "}" !== c; ) {
                switch (c) {
                  case "\n":
                    (u = f + 1),
                      (f = r.default.endOfIndent(i, u)) - u <= s &&
                        (this.error = new S.YAMLSemanticError(
                          this,
                    ...
                    break;
                  case ",":
                    this.items.push({ char: c, offset: f }), (f += 1);
                    break;
                  case "#":
                    var l = new n.default();
                  ...
                  default:
                    ...
                    if (!h) return (this.valueRange = new a.default(t, f)), f;
                    this.items.push(h),
                      (f = r.default.normalizeOffset(i, h.range.end));
                }
                c = i[(f = r.default.endOfWhiteSpace(i, f))];
              }
              return (
                (this.valueRange = new a.default(t, f + 1)),
                c &&
                  (this.items.push({ char: c, offset: f }),
              ...
              value: function(e) {
                for (
                  var r = this.context,
                    ...
                    s = e,
                    u = i[s];
                  "\n" === u && !n.default.atDocumentBoundary(i, s + 1);
                  u = i[s]
                ) {
                  var c = n.default.endOfBlockIndent(i, a, s + 1);
                  if (null === c || "#" === i[c]) break;
                  s = t.endOfLine(i, c, o);
                }
                return (
            ...
            },
            {
              ...
              get: function() {
                ...
                for (var i = "", s = t; s < r; ++s) {
                  var u = a[s];
                  if ("\n" === u) {
                    var c = n.default.foldNewline(a, s, -1);
                    (i += c.fold), (s = c.offset);
                  } else if (" " === u || "\t" === u) {
                    for (
                      var f = s, l = a[s + 1];
              ...
              get: function() {
                ...
                for (var u = "", c = r + 1; c < a - 1; ++c) {
                  ...
                  if ("\n" === f) {
                    ...
                    var l = n.default.foldNewline(s, c, i);
                    (u += l.fold),
                      (c = l.offset),
                      l.error &&
                        e.push(
                    ...
                    for (var d = c, h = s[c + 1]; " " === h || "\t" === h; )
                      h = s[(c += 1) + 1];
                    "\n" !== h && (u += c > d ? s.slice(d, c + 1) : f);
                  } else u += f;
                }
  ...
  var j = r(function(e, t) {
    ...
    var v = (function() {
      function e() {
        ...
        o(this, e),
          (p = function(t, o) {
            if (c.default.atDocumentBoundary(v.src, o)) return null;
            var s,
              p = new e(v, t),
              m = p.parseProps(o),
              g = m.props,
            ...
            switch (y) {
              case c.Type.ALIAS:
                s = new n.default(y, g);
                break;
              case c.Type.BLOCK_FOLDED:
              case c.Type.BLOCK_LITERAL:
                s = new r.default(y, g);
                break;
              case c.Type.FLOW_MAP:
              case c.Type.FLOW_SEQ:
                s = new u.default(y, g);
                break;
              case c.Type.MAP_KEY:
              case c.Type.MAP_VALUE:
              case c.Type.SEQ_ITEM:
                s = new i.default(y, g);
                break;
              case c.Type.COMMENT:
              case c.Type.PLAIN:
                s = new f.default(y, g);
                break;
              case c.Type.QUOTE_DOUBLE:
                s = new l.default(y, g);
                break;
              case c.Type.QUOTE_SINGLE:
                s = new d.default(y, g);
                break;
              default:
                return (
                  (s.error = new S.YAMLSyntaxError(
                    s,
                    "Unknown node type: ".concat(JSON.stringify(y))
                  )),
                  (s.range = new h.default(o, o + 1)),
                  s
                );
            }
            var b = s.parse(p, _),
            ...
            if (
              (w <= o &&
                ...
                (s.error.source = s),
                (w = o + 1)),
              (s.range = new h.default(o, w)),
              p.nodeStartsCollection(s))
            ) {
              s.error ||
                p.atLineStart ||
                p.parent.type !== c.Type.DOCUMENT ||
                (s.error = new S.YAMLSyntaxError(
                  s,
                  "Block collection must not have preceding content here (e.g. directives-end indicator)"
                ));
              var O = new a.default(s);
              return (
          ...
          (s = "parseNode") in (t = this)
            ...
            : (t[s] = p),
          (this.atLineStart = null != y ? y : m.atLineStart || !1),
          (this.inCollection = null != _ ? _ : m.inCollection || !1),
          (this.inFlow = null != b ? b : m.inFlow || !1),
          (this.indent = null != w ? w : m.indent),
          (this.lineStart = null != O ? O : m.lineStart),
          (this.parent = null != E ? E : m.parent || {}),
          (this.src = m.src);
      }
      return (
        s(e, null, [
            ...
            value: function(e, t, n) {
              switch (e[t]) {
                case "*":
                  return c.Type.ALIAS;
                case ">":
                  return c.Type.BLOCK_FOLDED;
                case "|":
                  return c.Type.BLOCK_LITERAL;
                case "{":
                  return c.Type.FLOW_MAP;
                case "[":
                  return c.Type.FLOW_SEQ;
                case "?":
                  return !n && c.default.atBlank(e, t + 1)
                    ? c.Type.MAP_KEY
                    : c.Type.PLAIN;
                case ":":
                  return !n && c.default.atBlank(e, t + 1)
                ...
                case "-":
                  return !n && c.default.atBlank(e, t + 1)
                    ...
                    : c.Type.PLAIN;
                case '"':
                  return c.Type.QUOTE_DOUBLE;
                case "'":
                  return c.Type.QUOTE_SINGLE;
                default:
                  return c.Type.PLAIN;
              }
            }
        ...
        s(e, [
          {
            ...
            value: function(e) {
              ...
              return (
                "\n" !== r[a] &&
                "\n" !== r[a - 1] &&
                ":" === r[(a = c.default.endOfWhiteSpace(r, a))]
              );
            }
          },
          {
            ...
            value: function(t) {
              for (
                var n = this.inFlow,
                  ...
                  o = [],
                  i = !1,
                  s = a[(t = c.default.endOfWhiteSpace(a, t))];
                s === c.Char.ANCHOR ||
                s === c.Char.COMMENT ||
                s === c.Char.TAG ||
                "\n" === s;
                ...
                if ("\n" === s) {
                  var u = t + 1,
                    f = c.default.endOfIndent(a, u),
                    l = f - (u + this.indent),
                    d = r.type === c.Type.SEQ_ITEM && r.context.atLineStart;
                  if (!c.default.nextNodeIsIndented(a[f], l, !d)) break;
                  (this.atLineStart = !0),
                    (this.lineStart = u),
                    (i = !1),
                    (t = f);
                } else if (s === c.Char.COMMENT) {
                  var p = c.default.endOfLine(a, t + 1);
                  o.push(new h.default(t, p)), (t = p);
                } else {
                  var v = c.default.endOfIdentifier(a, t + 1);
                  s === c.Char.TAG &&
                    "," === a[v] &&
                    /^[a-zA-Z0-9-]+\.[a-zA-Z0-9-]+,\d\d\d\d(-\d\d){0,2}\/\S/.test(
                      a.slice(t + 1, v + 13)
                    ) &&
                    (v = c.default.endOfIdentifier(a, v + 5)),
                    o.push(new h.default(t, v)),
                    (i = !0),
                    (t = c.default.endOfWhiteSpace(a, v));
                }
                s = a[t];
              }
              return (
                i && ":" === s && c.default.atBlank(a, t + 1) && (t -= 1),
  ...
  var Q = r(function(e, t) {
    ...
    var f = (function(e) {
      function t() {
        ...
        return (
          i(
            h(h((n = p(this, (e = c(t)).call.apply(e, [this].concat(a)))))),
            "items",
            []
          ),
          n
          ...
          },
          {
            ...
            value: function(e, r, a) {
              ...
              var h,
                p = !1,
                v = !1,
                m = this.items.reduce(function(t, r, a) {
                  ...
                  return (
                    v || -1 === c.indexOf("\n") || (v = !0),
                    d && a < o.items.length - 1 && (c += ","),
                    (c = (0, n.default)(c, u, s)),
                    t.push({ type: "item", str: c }),
                    t
                  );
                }, []);
              if (0 === m.length) h = s.start + s.end;
              else if (d) {
                var g = s.start,
                  y = s.end,
                  _ = m.map(function(e) {
    ...
    (t.default = f), i(f, "maxFlowStringSingleLineLength", 60);
  });
  n(Q);
  var W = r(function(e, t) {
    ...
    var i = (function(e) {
      function t(e) {
        var n;
        return o(this, t), ((n = p(this, c(t).call(this))).value = e), n;
      }
      return (
        u(t, r.default),
        s(t, [
        ...
        s(t, [
          ...
          },
          {
            ...
            value: function(e, t) {
              ...
              var r = this.key,
                a = this.value,
                o = r instanceof f.default && r.comment,
                s = !r || o || r instanceof i.default,
                u = e,
                c = u.doc,
                l = u.indent;
              e = Object.assign({}, e, { implicitKey: !s, indent: l + "  " });
              var d = c.schema.stringify(r, e, function() {
                o = null;
              });
              o && (d = (0, n.default)(d, e.indent, o)), (e.implicitKey = !1);
              var h = c.schema.stringify(a, e, t),
                p =
                  a && a.commentBefore
                    ? " #".concat(
      ...
      return (
        ...
        s(t, [
          ...
          },
          {
            ...
            value: function(e, n) {
              return e
                ? v(c(t.prototype), "toString", this).call(
                    this,
                    e,
                    {
      ...
      function t(e) {
        ...
        if ((o(this, t), e instanceof n.default)) {
          ...
          s instanceof a.default ||
            ...
            ((i = p(this, c(t).call(this, e.key, s))).range = e.range);
        } else i = p(this, c(t).call(this, new r.default(f), new a.default()));
        ...
        s(t, [
          {
            ...
            value: function(e, n) {
              var r = this.value;
              if (r.items.length > 1)
                return v(c(t.prototype), "toString", this).call(this, e, n);
              this.value = r.items[0];
              var a = v(c(t.prototype), "toString", this).call(this, e, n);
  ...
  var J = r(function(e, t) {
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.default = function e(t) {
        ...
        if ("object" !== a(t)) return s ? new o.default(t) : t;
        if (Array.isArray(t)) {
          var u = new i.default();
          return (
    ...
    var i,
      ...
      d = (function(e) {
        function t(e) {
          ...
          return (
            o(this, t),
            ((n = p(this, c(t).call(this))).source = e),
            (n.type = M.Type.ALIAS),
            n
          );
        }
          ...
          s(t, null, [
            {
              ...
              value: function(e, t) {
                var n = e.range,
                  ...
                  o = t.doc,
                  i = t.implicitKey,
                  s = Object.keys(a).find(function(e) {
                    return a[e] === r;
                  });
                if (s) return "*".concat(s).concat(i ? " " : "");
                var u = o.anchors.getName(r)
        ...
        (function e(t, i) {
          if (t && "object" === a(t)) {
            ...
            t instanceof n.default
              ...
              : t instanceof o.default && s && (i[s] = !0);
          }
          return i;
        })(e, {})
      );
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.default = function(e, t, a, o) {
        var i = o.indentAtStart,
          ...
          d = o.onOverflow;
        if (!u || u < 0) return e;
        var h = Math.max(1 + f, 1 + u - t.length);
        if (e.length <= h) return e;
        for (
          var p = [],
            v = {},
            m = u - ("number" == typeof i ? i : t.length),
            g = void 0,
            y = void 0,
            _ = !1,
            b = 0,
          ...
          if ("\n" === w) {
            ...
            if (b >= m)
              if (g) p.push(g), (m = g + h), (g = void 0);
              else if (a === r) {
                for (; " " === y || "\t" === y; )
                  (y = w), (w = e[(b += 1)]), (_ = !0);
                p.push(b - 2), (v[b - 2] = !0), (m = b - 2 + h), (g = void 0);
              } else _ = !0;
          }
          y = w;
        }
  ...
  var X = r(function(e, t) {
    ...
    function i(e, t) {
      var a = t.implicitKey,
        ...
        i = r.doubleQuoted,
        s = i.jsonEncoding,
        u = i.minMultiLineLength,
        c = JSON.stringify(e);
      if (s) return c;
      for (var f = "", l = 0, d = 0, h = c[d]; h; h = c[++d])
        if (
          (" " === h &&
            "\\" === c[d + 1] &&
            "n" === c[d + 2] &&
            ((f += c.slice(l, d) + "\\ "), (l = d += 1), (h = "\\")),
          "\\" === h)
        )
          switch (c[d + 1]) {
            case "u":
              f += c.slice(l, d);
              var p = c.substr(d + 2, 4);
              switch (p) {
                case "0000":
                  f += "\\0";
                  break;
      ...
      return (
        (f = l ? f + c.slice(l) : c),
        a ? f : (0, n.default)(f, o, n.FOLD_QUOTED, r.fold)
      );
    }
    function s(e, t) {
      var a = t.indent,
      ...
      var s =
        "'" + e.replace(/'/g, "''").replace(/\n+/g, "$&\n".concat(a)) + "'";
      return o ? s : (0, n.default)(s, a, n.FOLD_FLOW, r.fold);
    }
    function u(e, t, o) {
      var s = e.comment,
        u = e.type,
      ...
      var f = t.indent || (t.forceBlockIndent ? " " : ""),
        l = f ? "2" : "1",
        d =
          u !== M.Type.BLOCK_FOLDED &&
          (u === M.Type.BLOCK_LITERAL || !a(c, r.fold.lineWidth - f.length)),
        h = d ? "|" : ">";
      if (!c) return h + "\n";
      var p = "",
        v = "";
              ...
              if (
                ...
                return l || h || -1 === f.indexOf("\n")
                  ? -1 !== f.indexOf('"') && -1 === f.indexOf("'")
                    ...
                    : i(f, t)
                  : u(e, t, a);
              if (!l && !h && c !== M.Type.PLAIN && -1 !== f.indexOf("\n"))
                return u(e, t, a);
              var v = f.replace(/\n+/g, "$&\n".concat(d));
              if ("string" != typeof p.resolveScalar(v).value) return i(f, t);
              var m = l ? v : (0, n.default)(v, d, n.FOLD_FLOW, r.fold);
              return !o ||
                h ||
                (-1 === m.indexOf("\n") && -1 === o.indexOf("\n"))
                ? m
                : (a && a(), (0, U.addCommentBefore)(m, d, o));
            })(e, t, a);
          default:
            return null;
        }
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.checkKeyLength = function(e, t, n, r, a) {
        ...
        if (i > a + 1024) {
          ...
          e.push(
            new S.YAMLSemanticError(t, 'The "'.concat(c, '" key is too long'))
          );
        }
      }),
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.default = function(e, t) {
        if (t.type !== M.Type.MAP && t.type !== M.Type.FLOW_MAP) {
          var s = "A ".concat(t.type, " node cannot be resolved as a mapping");
          return e.errors.push(new S.YAMLSyntaxError(t, s)), null;
        }
        var u =
            t.type === M.Type.FLOW_MAP
              ? (function(e, t) {
                  for (
                    ...
                    (0, ee.checkKeyLength)(e.errors, t, c, a, i);
                    var f = t.items[c];
                    if ("string" == typeof f.char) {
                      ...
                      f.type === M.Type.COMMENT
                        ...
                        : ("," !== u &&
                          ...
                          r.push(new o.default(a, e.resolveNode(f))),
                          (a = void 0),
                          (s = !1));
                  }
                    ...
                    switch (c.type) {
                      ...
                      case M.Type.MAP_VALUE:
                        ...
                        if (!f && c.props.length > 0) {
                          (f = new n.default(M.Type.PLAIN, [])).context = {
                            parent: c,
                            src: c.context.src
                          };
                        ...
                        a.push(new o.default(i, e.resolveNode(f))),
                          (0, ee.checkKeyLength)(e.errors, t, u, i, s),
                          (i = void 0),
                          (s = null);
                        break;
                      default:
          ...
          f = u.items,
          l = new r.default();
        (l.items = f), (0, ee.resolveComments)(l, c);
        for (var d = 0; d < f.length; ++d) {
          var h = f[d].key;
          if (e.schema.merge && h && h.value === a.MERGE_KEY) {
            f[d] = new a.default(f[d]);
            var p = f[d].value.items,
              v = null;
            p.some(function(e) {
              if (e instanceof i.default) {
                var t = e.source.type;
            ...
            for (var m = d + 1; m < f.length; ++m) {
              var g = f[m].key;
              if (
                h === g ||
                (h && g && h.hasOwnProperty("value") && h.value === g.value)
              ) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.default = function(e, t) {
        ...
        var o =
                  ...
                  for (
                    ...
                    if ("string" == typeof f.char) {
                      ...
                      if (
                        ...
                        if ("[" !== u && ":" === l && void 0 === i) {
                          if ("," === u) {
                            ...
                            o || (0, ee.checkKeyLength)(e.errors, t, c, i, s);
                          } else i = null;
                          (s = null), (o = !1), (u = null);
                        } else if (
                          "[" === u ||
                      ...
                      if (u) {
                        ...
                        e.errors.push(new S.YAMLSemanticError(f, h));
                      }
                      var p = e.resolveNode(f);
                      void 0 === i
                        ? a.push(p)
          ...
          u = new r.default();
        return (
          (u.items = s), (0, ee.resolveComments)(u, i), (t.resolved = u), u
        );
      });
    var n = a(V),
      r = a(K);
  ...
  function he(e) {
    ...
    for (
      ...
      o.push(de(e, i, i + 16383 > s ? s : i + 16383));
    return (
      1 === r
        ? ((t = e[n - 1]),
          (a += se[t >> 2]),
      ...
      t = Math.abs(t),
        isNaN(t) || t === 1 / 0
          ...
          : ((i = Math.floor(Math.log(t) / Math.LN2)),
            ...
            (t += i + l >= 1 ? d / u : d * Math.pow(2, 1 - l)) * u >= 2 &&
              (i++, (u /= 2)),
            i + l >= f
              ? ((s = 0), (i = f))
              : i + l >= 1
              ? ((s = (t * u - 1) * Math.pow(2, a)), (i += l))
              : ((s = t * Math.pow(2, l - 1) * Math.pow(2, a)), (i = 0)));
      a >= 8;
          ...
          if (t) {
            if (
              ...
              return "number" != typeof t.length || (r = t.length) != r
                ? _e(e, 0)
                : Me(e, t);
            if ("Buffer" === t.type && ge(t.data)) return Me(e, t.data);
          }
          var r;
          throw new TypeError(
  ...
  function et(e) {
    return (function(e) {
      ...
      for (t = 0, n = 0; t < r; t += 4, n += 3)
        (a =
          (ue[e.charCodeAt(t)] << 18) |
          (ue[e.charCodeAt(t + 1)] << 12) |
          (ue[e.charCodeAt(t + 2)] << 6) |
          ue[e.charCodeAt(t + 3)]),
          (i[u++] = (a >> 16) & 255),
          (i[u++] = (a >> 8) & 255),
          (i[u++] = 255 & a);
      return (
        2 === o
          ? ((a = (ue[e.charCodeAt(t)] << 2) | (ue[e.charCodeAt(t + 1)] >> 4)),
            (i[u++] = 255 & a))
          : 1 === o &&
            ((a =
              (ue[e.charCodeAt(t)] << 10) |
              (ue[e.charCodeAt(t + 1)] << 4) |
              (ue[e.charCodeAt(t + 2)] >> 2)),
            (i[u++] = (a >> 8) & 255),
            (i[u++] = 255 & a)),
        i
      );
      ...
      stringify: function(e, t, r) {
        ...
        if (
          ((a =
            s instanceof be
              ? s.toString("base64")
              : be.from(s.buffer).toString("base64")),
          ...
          for (
            var u = n.options.lineWidth,
              c = Math.ceil(a.length / u),
              f = new Array(c),
              l = 0,
              d = 0;
            l < c;
            ...
            f[l] = a.substr(d, u);
          s = f.join(i === M.Type.BLOCK_LITERAL ? "\n" : " ");
        }
        return (0, X.stringify)({ comment: o, type: i, value: s }, t, r);
      }
    };
    t.binary = n;
    var r = [n];
  ...
  var at = r(function(e, t) {
    ...
    var i = {
      ...
      resolve: function(e, t, r, a, o, i, s, u, c) {
        u && (u = (u + "00").substr(1, 3));
        var f = Date.UTC(t, r - 1, a, o || 0, i || 0, s || 0, u || 0);
        if (c && "Z" !== c) {
  ...
  var ot = r(function(e, t) {
    ...
    var i = { nullStr: "null" };
    t.nullOptions = i;
    var s = { trueStr: "true", falseStr: "false" };
    t.boolOptions = s;
    var u = a.default.concat(
      [
        {
          class: null,
          default: !0,
        ...
        },
        {
          ...
          options: s,
          stringify: function(e) {
            return e.value ? s.trueStr : s.falseStr;
          }
        },
        {
          class: Boolean,
            ...
            value: function(e, t) {
              ...
              for (var n = 0; n < t.length; ++n) {
                ...
                if (o) {
                  var s = e.match(o);
                  if (s) {
                    var u = new h.default(i.apply(null, s));
                    return a && (u.format = a), u;
                  }
                }
              }
              return (
            ...
            value: function(e, t, n) {
              ...
              try {
                if (a) {
                  ...
                  var s = (0, X.resolve)(e, t);
                  "string" == typeof s &&
                    r.length > 0 &&
                    (t.resolved = this.resolveScalar(s, r));
                }
              } catch (n) {
                n.source || (n.source = t),
                  e.errors.push(n),
          ...
          },
          {
            ...
            value: function(e) {
              ...
              if (
                ...
                var s = o && o.constructor ? o.constructor.name : a(o);
          ...
          },
          {
            ...
            value: function(t, r, a) {
              ...
              var o = this.getTagObject(t),
                s = this.stringifyProps(t, o, r),
                u = o.stringify || e.defaultStringifier,
                c = u(t, r, a);
              return s
                ? t instanceof i.default && "{" !== c[0] && "[" !== c[0]
                  ? ""
                      .concat(s, "\n")
                      .concat(r.indent)
                      .concat(c)
          ...
          s(e, [
              ...
              value: function(e) {
                ...
                if (t) {
                  ...
                  if (s) {
                    ...
                    this.errors.push(new S.YAMLSemanticError(e, u));
                  } else if ("!" !== a || o) {
            ...
            },
            {
              ...
              value: function(e) {
                  ...
                  (((function(e) {
                    ...
                    switch (e.context.src[a]) {
                      case M.Char.COMMENT:
                        ...
                        var c = e.context.src.slice(a + 1, u),
                          f = e.header,
                          l = e.valueRange;
                        l && (a > l.start || (f && a > f.start))
                          ? s.after.push(c)
                          : s.before.push(c);
                        break;
                      case M.Char.ANCHOR:
                ...
                if (e.type === M.Type.ALIAS) {
                  ...
                  if (
                    ((t = new u.default(d)), n._cstAliases.push(t), !d.resolved)
                  ) {
                    this.warnings.push(
                      new S.YAMLWarning(
                        e,
            ...
            },
            {
              ...
              value: function(e) {
                ...
                return (0, f.default)(this.contents, e, n);
              }
            },
            {
              key: "toString",
              value: function() {
                ...
                if (this.contents) {
                  ...
                  var i = this.contents.comment,
                    s = this.schema.stringify(this.contents, o, function() {
                      i = null;
                    });
                  e.push((0, n.default)(s, "", i));
                } else
  ...
  var ut = r(function(e, t) {
    ...
    var s = {
      ...
      f = (function(e) {
        function t(e) {
          return o(this, t), p(this, c(t).call(this, Object.assign({}, s, e)));
        }
        return u(t, a.default), t;
      })();
    function l(e, t) {
      var r = (0, n.default)(e),
        a = new f(t).parse(r[0]);
                  ...
                  if (
                    ...
                    for (
                      var s = n.position,
                        r = s.start,
                        o = s.end,
                        u = [o.line].concat(r.line === o.line ? [] : r.line),
                        c = 0,
                        f = u;
                      c < f.length;
                      c++
          ...
          .forEach(function(e) {
            ...
            !(function(e, t, r) {
                ...
                if (o.trailingComment)
                  throw new Error(
                    "Unexpected multiple trailing comment at " +
                      ft.getPointText(e.position.start)
                  );
                return ct.defineParents(e, o), void (o.trailingComment = e);
              }
              for (var i = a; i >= r.position.start.line; i--) {
                ...
                for (;;) {
                  if (n(u, e))
                    return ct.defineParents(e, u), void u.endComments.push(e);
                  if (!u._parent) break;
                  u = u._parent;
                }
                break;
              ...
              for (var i = a + 1; i <= r.position.end.line; i++) {
                ...
                if (c)
                  return ct.defineParents(e, c), void c.leadingComments.push(e);
              }
              var f = r.children[1];
              ct.defineParents(e, f), f.endComments.push(e);
            })(e, t, r[0]);
          });
      });
  });
  ...
  var yt = r(function(e, t) {
    (t.__esModule = !0),
      (t.transformAlias = function(e, t) {
        var n = e.cstNode;
        return gt.createAlias(
          t.transformRange({
            start: n.valueRange.start - 1,
            end: n.valueRange.end
          }),
        ...
        for (
          ...
          switch (l) {
            case wt.PropLeadingCharacter.Tag:
              (o = o || f), (i = St.createTag(t.transformRange(f), e.tag));
              break;
            case wt.PropLeadingCharacter.Anchor:
              (o = o || f),
                (s = Ot.createAnchor(t.transformRange(f), r.anchor));
              break;
            case wt.PropLeadingCharacter.Comment:
              var d = Et.createComment(
                t.transformRange(f),
                t.text.slice(f.start + 1, f.end)
              );
              t.comments.push(d),
                !n(d) &&
                  o &&
                  o.end <= f.start &&
                  f.end <= r.valueRange.start &&
                  a.push(d);
              break;
            default:
              throw new Error(
    ...
    (t.__esModule = !0),
      ...
      (t.transformAstBlockValue = function(e, t) {
        var r = e.cstNode,
          ...
          o = r.header.end - r.header.start - 1 - a != 0,
          i = t.transformRange({
            start: r.header.start,
            end: r.valueRange.end
          }),
          s = null,
          u = At.transformContent(e, t, function(e) {
            if (
              !(
    ...
    (t.__esModule = !0),
      (t.transformDirective = function(e, t) {
        return (
          ...
          Nt.createDirective(t.transformRange(e.range), e.name, e.parameters)
        );
      });
  });
  n(xt);
    ...
    (t.__esModule = !0),
      (t.transformDocumentBody = function(e, t, n) {
        var r,
          ...
          o = (function(e, t, n) {
            for (
              var r = [],
                ...
                i = [],
                s = !1,
                u = e.contents.length - 1;
              u >= 0;
              u--
            ) {
              var c = e.contents[u];
              if ("COMMENT" === c.type) {
                var f = t.transformNode(c);
                n && n.line === f.position.start.line
                  ? i.unshift(f)
                  : s
                  ? r.unshift(f)
                  : f.position.start.offset >= e.valueRange.end
                  ? o.unshift(f)
                  : a.unshift(f);
              } else s = !0;
            }
            if (o.length > 1)
              throw new Error(
                "Unexpected multiple document trailing comments at " +
                  ft.getPointText(o[1].position.start)
              );
            if (i.length > 1)
              throw new Error(
                "Unexpected multiple documentHead trailing comments at " +
                  ft.getPointText(i[1].position.start)
              );
            return {
              comments: r,
              endComments: a,
          ...
          c = o.documentHeadTrailingComment,
          f = t.transformNode(e.contents),
          l = (function(e, t, n) {
            var r = Ut.getMatchIndex(n.text.slice(e.valueRange.end), /^\.\.\./),
              a =
                -1 === r ? e.valueRange.end : Math.max(0, e.valueRange.end - 1),
              o = n.transformRange({
                start: null !== t ? t.position.start.offset : a,
                end: a
              }),
              i = -1 === r ? o.end : n.transformOffset(e.valueRange.end + 3);
            return { position: o, documentEndPoint: i };
          })(a, f, t),
          d = l.position,
          h = l.documentEndPoint;
        return (
          (r = t.comments).push.apply(r, i.concat(s)),
          {
            documentBody: Bt.createDocumentBody(d, f, s),
            documentEndPoint: h,
    ...
    (t.__esModule = !0),
      (t.transformDocumentHead = function(e, t) {
        var n,
          ...
          s = a.endComments,
          u = (function(e, t, n) {
            var r = Ut.getMatchIndex(
                n.text.slice(0, e.valueRange.start),
                /---\s*$/
              ),
              a =
                -1 === r
                  ? { start: e.valueRange.start, end: e.valueRange.start }
                  : { start: r, end: r + 3 };
            return (
              0 !== t.length && (a.start = t[0].position.start.offset),
              {
          ...
          f = u.endMarkerPoint;
        return (
          (n = t.comments).push.apply(n, i.concat(s)),
          {
            createDocumentHeadWithTrailingComment: function(e) {
              return e && t.comments.push(e), Qt.createDocumentHead(c, o, s, e);
            },
    ...
    (t.__esModule = !0),
      (t.transformDocument = function(e, t) {
        var n = Wt.transformDocumentHead(e, t),
          ...
          o = Ft.transformDocumentBody(e, t, a),
          i = o.documentBody,
          s = o.documentEndPoint,
          u = o.documentTrailingComment,
          c = r(o.documentHeadTrailingComment);
        return (
          u && t.comments.push(u),
          It.createDocument(Dt.createPosition(c.position.start, s), c, i, u)
        );
      });
  });
  n(Vt);
    ...
    (t.__esModule = !0),
      (t.getFlowMapItemAdditionalRanges = function(e) {
        var t = ["?", ":"].map(function(t) {
          ...
          return n ? { start: n.offset, end: n.offset + 1 } : null;
        });
    ...
    (t.__esModule = !0),
      (t.transformAstPair = function(e, t, n, r, a) {
        var o = t.transformNode(e.key),
          ...
          s =
            o || r
              ? Zt.createMappingKey(
                  t.transformRange({
                    start: r ? r.start : o.position.start.offset,
                    end: o ? o.position.end.offset : r.start + 1
                  }),
                  o
                )
              : null,
          u =
            i || a
              ? Xt.createMappingValue(
                  t.transformRange({
                    start: a ? a.start : i.position.start.offset,
                    end: i ? i.position.end.offset : a.start + 1
                  }),
                  i
                )
              : null;
        return n(
          ...
          s ||
            Zt.createMappingKey(Dt.createEmptyPosition(u.position.start), null),
          u ||
            Xt.createMappingValue(Dt.createEmptyPosition(s.position.end), null)
        );
      });
  });
  n(en);
      ...
      (t.transformFlowMap = function(e, t) {
        var n = Jt.extractComments(e.cstNode.items, t),
          ...
          a = e.items.map(function(e, n) {
            ...
            return en.transformAstPair(e, t, qt.createFlowMappingItem, i, s);
          }),
          o = n[0],
          i = Yt.getLast(n);
        return $t.createFlowMapping(
          t.transformRange({ start: o.offset, end: i.offset + 1 }),
          t.transformContent(e),
          a
        );
      });
      ...
      (t.transformFlowSeq = function(e, t) {
        var n = Jt.extractComments(e.cstNode.items, t),
          ...
          a = e.items.map(function(e, n) {
            ...
            return en.transformAstPair(e, t, qt.createFlowMappingItem, s, u);
          }),
          o = n[0],
          i = Yt.getLast(n);
        ...
        var r = (function(e) {
          ...
          a = e.items.map(function(e, n) {
            var a = r[n],
              ...
              i = o[0],
              s = o[1];
            return en.transformAstPair(e, t, sn.createMappingItem, i, s);
          });
    ...
    (t.__esModule = !0),
      (t.transformPlain = function(e, t) {
        ...
        return cn.createPlain(
          t.transformRange({
            start: n.valueRange.start,
            end: fn.findLastCharIndex(t.text, n.valueRange.end - 1, /\S/) + 1
          }),
          t.transformContent(e),
          n.strValue
        );
  ...
  var gn = r(function(e, t) {
    (t.__esModule = !0),
      (t.transformQuoteSingle = function(e, t) {
        return mn.createQuoteSingle(pn.transformAstQuoteValue(e, t));
      });
  });
  n(gn);
      ...
      (t.transformSeq = function(e, t) {
        var n = Jt.extractComments(e.cstNode.items, t).map(function(n, r) {
          ...
          return _n.createSequenceItem(
            Dt.createPosition(
              t.transformOffset(n.valueRange.start),
              null === a
                ? t.transformOffset(n.valueRange.start + 1)
                : a.position.end
            ),
            a
          );
    ...
    (t.__esModule = !0),
      (t.transformNode = function(e, t) {
        ...
        switch (e.type) {
          ...
          case "COMMENT":
            return Ct.transformComment(e, t);
          case "DIRECTIVE":
            return xt.transformDirective(e, t);
          case "DOCUMENT":
  ...
  var Sn = r(function(e, t) {
    (t.__esModule = !0),
      (t.transformOffset = function(e, t) {
        ...
        if (null === n) throw new Error("Unexpected offset " + e);
    ...
    (t.__esModule = !0),
      (t.transformRange = function(e, t) {
        return Dt.createPosition(
          t.transformOffset(e.start),
          t.transformOffset(e.end)
        );
      });
  });
  n(An);
        ...
        if (null !== t && "children" in t) {
          ...
          if ((u.forEach(e), "document" === t.type)) {
            var c = t.children,
              f = c[0],
              l = c[1];
            f.position.start.offset === f.position.end.offset
              ? (f.position.start = f.position.end = l.position.start)
              : l.position.start.offset === l.position.end.offset &&
                (l.position.start = l.position.end = f.position.end);
          }
          var d = Tn.createUpdater(t.position, n, r, i),
            h = Tn.createUpdater(t.position, a, o, s);
          "endComments" in t &&
          ...
          if (0 !== p.length) {
            ...
            d(v.position.start),
              ...
              "trailingComment" in m &&
                m.trailingComment &&
                h(m.trailingComment.position.end);
          }
        }
      });
  });
  ...
  var kn = r(function(e, t) {
    (t.__esModule = !0),
      (t.parse = function(e) {
        var t = ut.default.parseAllDocuments(e, {
            merge: !0,
            keepCstNodes: !0
          }),
          n = [],
          r = {
            ...
            transformOffset: function(e) {
              return Sn.transformOffset(e, r);
            },
            transformRange: function(e) {
              return An.transformRange(e, r);
            },
            transformNode: function(e) {
              return wn.transformNode(e, r);
            },
            transformContent: function(e) {
              return At.transformContent(e, r);
            }
          },
          a = t.find(function(e) {
            return 0 !== e.errors.length;
          });
        if (a) throw En.transformError(a.errors[0], r);
        var o = ht.createRoot(
          r.transformRange({ start: 0, end: r.text.length }),
          t.map(r.transformNode),
          n
        );
        return (
          lt.attachComments(o), Ln.updatePositions(o), Pn.removeFakeNodes(o), o
        );
      });
  });
  n(kn);
  var Cn = r(function(e, t) {
    (t.__esModule = !0), w.__exportStar(kn, t);
  });
  return (
    n(Cn),
    {
