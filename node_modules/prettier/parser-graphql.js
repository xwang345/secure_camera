!(function(e, n) {
      ...
      (n.printError = function(e) {
        ...
        if (e.nodes)
          e.nodes.forEach(function(e) {
            e.loc &&
              n.push(
                t(e.loc.source, (0, o.getLocation)(e.loc.source, e.loc.start))
              );
          });
      ...
      i && r
        ...
        : s &&
          (v = s.reduce(function(e, n) {
            return (
              n.loc && e.push((0, o.getLocation)(n.loc.source, n.loc.start)), e
            );
          }, [])),
  ...
  var p = i(function(e, n) {
    ...
    function d(e, n) {
      ...
      if (N < 32 && 9 !== N && 10 !== N && 13 !== N)
        throw (0, v.syntaxError)(
          t,
          d,
          "Cannot contain the invalid character " + l(N) + "."
        );
      switch (N) {
        case 33:
                ...
                for (; f < d.length && null !== (p = c.call(d, f)); ) {
                  ...
                  if (p < 32 && 9 !== p && 10 !== p && 13 !== p)
                    throw (0, v.syntaxError)(
                      e,
                      f,
                      "Invalid character within String: " + l(p) + "."
                    );
                  92 === p &&
                  34 === c.call(d, f + 1) &&
                  34 === c.call(d, f + 2) &&
            ...
            : (function(e, n, t, r, i) {
                ...
                for (
                  ...
                  if (34 === E)
                    return (
                      (T += u.call(o, f, d)),
                      new s(a.STRING, n, d + 1, t, r, i, T)
                    );
                  if (E < 32 && 9 !== E)
                    throw (0, v.syntaxError)(
                      e,
                      d,
                      "Invalid character within String: " + l(E) + "."
                    );
                  if ((++d, 92 === E)) {
    ...
    function f(e, n, t) {
      ...
      throw (0,
      v.syntaxError)(e, i, "Invalid number, expected digit but got: " + l(o) + ".");
    }
    function p(e) {
      return e >= 48 && e <= 57
        ? e - 48
  ...
  var I = i(function(e, n) {
    ...
    function u(e) {
      return Q(e, p.TokenKind.PAREN_L)
        ? z(e, p.TokenKind.PAREN_L, s, p.TokenKind.PAREN_R)
        : [];
    }
    function s(e) {
      var n = e.token;
    ...
    function l(e) {
      var n = e.token;
      return (
        X(e, p.TokenKind.DOLLAR),
        { kind: a.Kind.VARIABLE, name: t(e), loc: Y(e, n) }
      );
    }
    function d(e) {
      var n = e.token;
    ...
    function f(e) {
      return Q(e, p.TokenKind.SPREAD)
        ? (function(e) {
            var n = e.token;
            if (
              (X(e, p.TokenKind.SPREAD),
              Q(e, p.TokenKind.NAME) && "on" !== e.token.value)
            )
              return {
    ...
    function E(e, n) {
      var t = n ? k : I;
      return Q(e, p.TokenKind.PAREN_L)
        ? z(e, p.TokenKind.PAREN_L, t, p.TokenKind.PAREN_R)
        : [];
    }
    function I(e) {
      var n = e.token;
    ...
    function y(e, n) {
      ...
      switch (t.kind) {
        ...
        case p.TokenKind.INT:
          return (
            e.advance(), { kind: a.Kind.INT, value: t.value, loc: Y(e, t) }
          );
        case p.TokenKind.FLOAT:
          return (
            e.advance(), { kind: a.Kind.FLOAT, value: t.value, loc: Y(e, t) }
          );
        ...
        case p.TokenKind.NAME:
          return "true" === t.value || "false" === t.value
            ? (e.advance(),
              { kind: a.Kind.BOOLEAN, value: "true" === t.value, loc: Y(e, t) })
            : "null" === t.value
            ? (e.advance(), { kind: a.Kind.NULL, loc: Y(e, t) })
            : (e.advance(),
              { kind: a.Kind.ENUM, value: t.value, loc: Y(e, t) });
    ...
    function K(e) {
      ...
      return (
        q(e, p.TokenKind.BRACKET_L)
          ...
          : (t = L(e)),
        q(e, p.TokenKind.BANG)
          ? { kind: a.Kind.NON_NULL_TYPE, type: t, loc: Y(e, n) }
          : t
      );
    }
    function L(e) {
                  ...
                  case "type":
                    return (function(e) {
                      ...
                      var r = t(e),
                        ...
                        o = g(e, !0),
                        c = C(e);
                      if (0 === i.length && 0 === o.length && 0 === c.length)
                        throw $(e);
                      return {
    ...
    function M(e) {
      return Q(e, p.TokenKind.PAREN_L)
        ? z(e, p.TokenKind.PAREN_L, x, p.TokenKind.PAREN_R)
        : [];
    }
    function x(e) {
      var n = e.token,
    ...
    function j(e) {
      return Q(e, p.TokenKind.BRACE_L)
        ? z(e, p.TokenKind.BRACE_L, U, p.TokenKind.BRACE_R)
        : [];
    }
    function U(e) {
      var n = e.token,
    ...
    function V(e) {
      return Q(e, p.TokenKind.BRACE_L)
        ? z(e, p.TokenKind.BRACE_L, x, p.TokenKind.BRACE_R)
        : [];
    }
    function G(e) {
      var n = e.token,
    ...
    function $(e, n) {
      var t = n || e.token;
      return (0,
      v.syntaxError)(e.source, t.start, "Unexpected " + (0, p.getTokenDesc)(t));
    }
    function z(e, n, t, r) {
      X(e, n);
    ...
    Object.defineProperty(n, "__esModule", { value: !0 }),
      (n.visit = function(e, n) {
        ...
        do {
          ...
          if (I) {
            if (
              ((v = 0 === T.length ? void 0 : p[p.length - 1]),
              (f = E),
              (E = T.pop()),
              k)
            ) {
