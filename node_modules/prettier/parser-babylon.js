!(function(t, e) {
  ...
  s(function(t) {
    t.exports = function(t) {
      ...
      var e;
      t = "string" == typeof (e = t) ? e.replace(u(), "") : e;
  ...
  var x = function(t, e) {
        ...
        (function t(e, s) {
          if (e && "object" === l(e))
            if (Array.isArray(e)) {
              ...
              for (var p = Object.keys(e), c = 0; c < p.length; c++) {
                var u = p[c];
                t(e[u], s);
              }
              s(e);
    ...
    v = s(function(t, e) {
        ...
        return t < 65
          ...
          : t <= 90 ||
              (t < 97
                ...
                : t <= 122 ||
                  (t <= 65535
                    ? t >= 170 && y.test(String.fromCharCode(t))
                    : g(t, v)));
      }
      function w(t) {
        return t < 48
      ...
      var D = function(t, e, s, i) {
        ...
        _ = {
          braceStatement: new D("{", !1),
          braceExpression: new D("{", !0),
          templateQuasi: new D("${", !0),
          parenStatement: new D("(", !1),
          parenExpression: new D("(", !0),
          template: new D("`", !0, !0, function(t) {
            return t.readTmplToken();
          }),
          functionExpression: new D("function", !0)
        };
      (h.parenR.updateContext = h.braceR.updateContext = function() {
        if (1 !== this.state.context.length) {
          var t = this.state.context.pop();
          t === _.braceStatement && this.curContext() === _.functionExpression
        ...
        (h.name.updateContext = function(t) {
          "of" !== this.state.value || this.curContext() !== _.parenStatement
            ? ((this.state.exprAllowed = !1),
              (t !== h._let && t !== h._const && t !== h._var) ||
                (S.test(this.input.slice(this.state.end)) &&
                  (this.state.exprAllowed = !0)),
        ...
        (h.braceL.updateContext = function(t) {
          this.state.context.push(
            this.braceIsBlock(t) ? _.braceStatement : _.braceExpression
          ),
            (this.state.exprAllowed = !0);
        }),
        (h.dollarBraceL.updateContext = function() {
          this.state.context.push(_.templateQuasi),
            (this.state.exprAllowed = !0);
        }),
        (h.parenL.updateContext = function(t) {
          var e =
            t === h._if || t === h._for || t === h._with || t === h._while;
          this.state.context.push(e ? _.parenStatement : _.parenExpression),
            (this.state.exprAllowed = !0);
        }),
        ...
        (h._function.updateContext = h._class.updateContext = function(t) {
          this.state.exprAllowed &&
            !this.braceIsBlock(t) &&
            this.state.context.push(_.functionExpression),
            (this.state.exprAllowed = !1);
        }),
        (h.backQuote.updateContext = function() {
          this.curContext() === _.template
            ? this.state.context.pop()
            : this.state.context.push(_.template),
            (this.state.exprAllowed = !1);
        });
      var R = /^[\da-fA-F]+$/,
        j = /^\d+$/;
      ...
      function B(t) {
        ...
        if ("JSXMemberExpression" === t.type)
          return B(t.object) + "." + B(t.property);
        throw new Error("Node had unexpected type: " + t.type);
      }
      (_.j_oTag = new D("<tag", !1)),
        (_.j_cTag = new D("</tag", !1)),
        (_.j_expr = new D("<tag>...</tag>", !0, !0)),
        ...
        (h.jsxTagStart.updateContext = function() {
          this.state.context.push(_.j_expr),
            this.state.context.push(_.j_oTag),
            (this.state.exprAllowed = !1);
        }),
        (h.jsxTagEnd.updateContext = function(t) {
          var e = this.state.context.pop();
          (e === _.j_oTag && t === h.slash) || e === _.j_cTag
            ? (this.state.context.pop(),
              (this.state.exprAllowed = this.curContext() === _.j_expr))
            : (this.state.exprAllowed = !0);
        });
      var q = {
        sourceType: "script",
              ...
              var i = void 0 === s ? {} : s,
                ...
                n = (function(t, e) {
                  var s,
                    i = 1,
                    r = 0;
                  for (I.lastIndex = 0; (s = I.exec(t)) && s.index < e; )
                    i++, (r = I.lastIndex);
                  return new U(i, e - r);
                })(this.input, t);
              e += " (" + n.line + ":" + n.column + ")";
            ...
            return (
              ...
              (s.processComment = function(t) {
                if (!("Program" === t.type && t.body.length > 0)) {
                  ...
                  for (
                    n.length > 0 && K(n).start >= t.start && (e = n.pop());
                    n.length > 0 && K(n).start >= t.start;
                  ...
                  if (
                    ...
                    var h = K(this.state.leadingComments);
                  ...
                  if (s) {
                    if (s.leadingComments)
                      if (
                        ...
                        K(s.leadingComments).end <= t.start
                      )
                    ...
                    if (K(this.state.leadingComments).end <= t.start) {
                  ...
                  (this.state.commentPreviousNode = t),
                    i &&
                      (i.length && i[0].start >= t.start && K(i).end <= t.end
                        ? (t.innerComments = i)
      ...
      var z = (function(t) {
          ...
          (function(t) {
            function e(e, s) {
              var i;
              return (
                ((i = t.call(this) || this).state = new X()),
                i.state.init(e, s),
                (i.isLookahead = !1),
                i
              );
            ...
            return (
              ...
              (s.readWord1 = function() {
                ...
                for (
                  ...
                  if (w(i)) this.state.pos += i <= 65535 ? 1 : 2;
              ...
              (s.braceIsBlock = function(t) {
                if (t === h.colon) {
                  ...
                  if (e === _.braceStatement || e === _.braceExpression)
                    return !e.isExpr;
                }
                return t === h._return
                  ? S.test(
                  ...
                  : t === h._else ||
                      ...
                      t === h.parenR ||
                      (t === h.braceL
                        ? this.curContext() === _.braceStatement
            ...
            return (
              ...
              (s.parseTryStatement = function(t) {
                if (
                  ...
                  if ((this.next(), this.match(h.parenL))) {
                    ...
                    this.checkLVal(e.param, !0, s, "catch clause"),
              ...
              (s.parseClassMemberWithIsStatic = function(t, e, s, i) {
                ...
                var l = this.parseClassPropertyName(e),
                  ...
                  d = "Identifier" === l.type;
                if (
                  (this.parsePostMemberNameModifiers(c), this.isClassMethod())
                ) {
                  if (((p.kind = "method"), u))
            ...
            (function(t) {
              ...
              return (
                ...
                (s.parseMaybeAssign = function(t, e, s, i) {
                  ...
                  if (
                    (s && (p = s.call(this, p, a, n)), this.state.type.isAssign)
                  ) {
                    var c,
                    ...
                    return (
                      ...
                      d && this.shouldParseAsyncArrow()
                        ? ((r.stop = !0),
                          ...
                          (this.state.yieldOrAwaitInPossibleArrowParameters = u))
                        : (this.toReferencedList(f.arguments),
                ...
                (s.parseParenAndDistinguishExpression = function(t) {
                  ...
                  for (
                    ...
                    l.push(
                      this.parseMaybeAssign(!1, u, this.parseParenItem, d)
                    );
                  }
                ...
                (s.parseObj = function(t, e) {
                  ...
                  for (var n = null; !this.eat(h.braceR); ) {
                    ...
                    (o.method = !1),
                      (t || e) &&
                        ((l = this.state.start), (u = this.state.startLoc)),
                      t || (p = this.eat(h.star));
            ...
            return (function(t) {
              ...
              return (
                ...
                (s.readToken = function(e) {
                  ...
                  if (s === _.j_expr) return this.jsxReadToken();
                  if (s === _.j_oTag || s === _.j_cTag) {
                    if (b(e)) return this.jsxReadWord();
                    if (62 === e)
                      return ++this.state.pos, this.finishToken(h.jsxTagEnd);
                    if ((34 === e || 39 === e) && s === _.j_oTag)
                ...
                (s.updateContext = function(e) {
                  if (this.match(h.braceL)) {
                    var s = this.curContext();
                    s === _.j_oTag
                      ? this.state.context.push(_.braceExpression)
                      : s === _.j_expr
                      ? this.state.context.push(_.templateQuasi)
                    ...
                    (this.state.context.length -= 2),
                      this.state.context.push(_.j_cTag),
                      (this.state.exprAllowed = !1);
                  }
                }),
                e
            ...
            return (function(t) {
              ...
              return (
                    ...
                    i.forEach(function(t) {
                      !(function(t) {
                        ...
                        ? "DeclareModuleExports" === t.type &&
                          ...
                          (n = "CommonJS"),
                          (o = !0))
                        : ("CommonJS" === n && e.unexpected(t.start, p),
                          (n = "ES"));
                    }),
                    (t.kind = n || "CommonJS"),
                ...
                (s.checkReservedType = function(t, e) {
                  T.indexOf(t) > -1 &&
                    this.raise(e, "Cannot overwrite primitive type " + t);
                }),
                ...
                (s.flowParseObjectType = function(t) {
                  ...
                  for (
                    s && this.match(h.braceBarL)
                      ? (this.expect(h.braceBarL), (o = h.braceBarR), (p = !0))
                      : (this.expect(h.braceL), (o = h.braceR), (p = !1)),
                      c.exact = p;
                    !this.match(o);
                    ...
                    var x = this.flowParseVariance();
                    if (this.eat(h.bracketL))
                      null != d && this.unexpected(d),
                        this.eat(h.bracketL)
                          ? (x && this.unexpected(x.start),
                            c.internalSlots.push(
                              this.flowParseObjectTypeInternalSlot(f, u)
                            ))
                          : c.indexers.push(
                              this.flowParseObjectTypeIndexer(f, u, x)
                            );
                    else if (this.match(h.parenL) || this.isRelational("<"))
                      null != d && this.unexpected(d),
                        x && this.unexpected(x.start),
                        c.callProperties.push(
                          this.flowParseObjectTypeCallProperty(f, u)
                        );
                    else {
                      var v = "init";
                      if (
                        ...
                        (P.type !== h.name &&
                          P.type !== h.string &&
                          P.type !== h.num) ||
                          ((v = this.state.value), this.next());
                      }
                      var g = this.flowParseObjectTypeProperty(
                        f,
                        u,
                        d,
                        x,
                      ...
                      null === g ? (l = !0) : c.properties.push(g);
                    }
                    this.flowObjectTypeSemicolon();
                  }
                  this.expect(o), i && (c.inexact = l);
                  var b = this.finishNode(c, "ObjectTypeAnnotation");
                ...
                (s.parseConditional = function(e, s, i, r, a) {
                  ...
                  if (f || x.length > 0) {
                    ...
                    if (
                      ...
                      (this.state = p),
                        (this.state.noArrowAt = v.concat(y[0].start));
                      var w = this.tryParseConditionalConsequent();
                      (d = w.consequent), (f = w.failed);
                    }
                  ...
                  return (
                    ...
                    (l.test = e),
                    (l.consequent = d),
                    (l.alternate = this.forwardNoArrowParamsConversionAt(
                      l,
                      function() {
              ...
              return (
                ...
                (s.parseMaybeAssign = function() {
                  ...
                  if (this.match(h.jsxTagStart)) {
                    ...
                    try {
                      var c;
                      return (c = t.prototype.parseMaybeAssign).call.apply(
                        c,
                        [this].concat(n)
                      );
                    } catch (t) {
                  ...
                  try {
                    ...
                    (r = this.tsParseTypeParameters()),
                      "ArrowFunctionExpression" !==
                        (i = (u = t.prototype.parseMaybeAssign).call.apply(
                          u,
                          [this].concat(n)
  ...
  function b(e, s, i) {
    var r,
      a = v,
      n = [
        g({ strictMode: !0 }, ["decorators-legacy"]),
        g({ strictMode: !1 }, ["decorators-legacy"]),
        g({ strictMode: !0 }, [["decorators", { decoratorsBeforeExport: !1 }]]),
        g({ strictMode: !1 }, [["decorators", { decoratorsBeforeExport: !1 }]])
      ],
      o = i && "babylon" !== i.parser ? "parseExpression" : "parse";
    try {
      r = (function(t, e) {
    ...
    return delete r.tokens, x(r, Object.assign({}, i, { originalText: e }));
  }
  function w(e, s) {
    switch (e.type) {
      case "ArrayExpression":
  ...
  var T = Object.assign({ parse: b, astFormat: "estree", hasPragma: P }, c);
  return {
    parsers: {
      babylon: T,
      ...
      "json-stringify": Object.assign(
        {
          parse: function(t, e, s) {
            var i = b(t, 0, Object.assign({}, s, { parser: "json" }));
            return i.comments.forEach(w), w(i), i;
          },
