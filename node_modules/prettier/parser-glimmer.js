!(function(t, e) {
  ...
  function d(t, e, r) {
    return { type: t, value: e, original: e, loc: y(r || null) };
  }
  function m(t, e) {
    return { type: "Hash", pairs: t || [], loc: y(e || null) };
  }
  function g(t) {
    return t || null;
  }
  ...
  function y() {
    ...
    if (1 === r.length) {
      ...
      return n && "object" === e(n)
        ? {
            source: g(n.source),
            start: v(n.start.line, n.start.column),
            end: v(n.end.line, n.end.column)
          }
        : b;
    }
    var i = r[0],
      ...
      o = r[2],
      l = r[3];
    return { source: g(r[4]), start: v(i, s), end: v(o, l) };
  }
  var k = {
    ...
    comment: function(t, e) {
      return { type: "CommentStatement", value: t, loc: y(e || null) };
    },
    mustacheComment: function(t, e) {
      return { type: "MustacheCommentStatement", value: t, loc: y(e || null) };
    },
    ...
    attr: function(t, e, r) {
      return { type: "AttrNode", name: t, value: e, loc: y(r || null) };
    },
    text: function(t, e) {
      return { type: "TextNode", chars: t || "", loc: y(e || null) };
    },
    ...
    path: f,
    concat: function(t, e) {
      return { type: "ConcatStatement", parts: t || [], loc: y(e || null) };
    },
    hash: m,
    pair: function(t, e, r) {
      return { type: "HashPair", key: t, value: e, loc: y(r || null) };
    },
    literal: d,
    ...
    boolean: S("BooleanLiteral"),
    number: S("NumberLiteral"),
    undefined: (function(t) {
      ...
      return d("UndefinedLiteral", void 0);
    }),
    null: function() {
      return d("NullLiteral", null);
    }
  };
  function S(t) {
    return function(e) {
    ...
    var e = (function(t) {
      ...
      if (-1 !== n && e > n && "|" === r[n + 1].charAt(0)) {
        ...
        if ("|" !== i.charAt(i.length - 1) || 2 !== i.match(/\|/g).length)
          throw new w("Invalid block parameters syntax: '" + i + "'", t.loc);
        ...
        if (0 === s.length)
          throw new w("Cannot use zero block parameters: '" + i + "'", t.loc);
  ...
  !(function() {
    function t(t, e) {
      void 0 === e && (e = {}),
        ...
        (this.tokenizer = new V(this, t));
    }
    Object.defineProperty(t.prototype, "token", {
      get: function() {
        return R(this._token);
      },
      set: function(t) {
        this._token = t;
      },
  ...
  function M(t) {
    for (var r = 1; r < arguments.length; r++) {
      ...
      if (null !== a && "object" === e(a))
        for (var n = H(a), i = 0; i < n.length; i++) {
          var s = n[i];
          t[s] = a[s];
        }
    }
        ...
        n(e, [
          ...
          },
          {
            ...
            value: function(t) {
              this.cursorCount = 0;
              var e,
                r = k.program([], t.blockParams, t.loc),
                a = t.body.length;
                ...
                "in-element" === r.original &&
                  (n = (function(t, e, r) {
                    ...
                    e.pairs.forEach(function(t) {
                      if ("guid" === t.key)
                        throw new w("Cannot pass `guid` from user space", r);
                      "nextSibling" === t.key && (a = !0);
                    });
                    var n = k.literal("StringLiteral", t),
                      i = k.pair("guid", n);
                    if ((e.pairs.unshift(i), !a)) {
                      var s = k.literal("NullLiteral", null),
                        o = k.pair("nextSibling", s);
                      e.pairs.push(o);
                    }
                    return e;
                  })(this.cursor(), n, t.loc));
                var o = k.block(r, a, n, i, s, t.loc);
                P(this.currentElement(), o);
              ...
              if ("comment" !== e.state) {
                ...
                if (t.path.type.match(/Literal$/))
                  ...
                  var i = $(this, t),
                    ...
                    o = i.params,
                    l = i.hash;
                  r = k.mustache(s, o, l, !a, n);
                }
                switch (e.state) {
                  case "tagName":
                    F(this.currentStartTag, r),
          ...
          },
          {
            ...
            value: function(t) {
              for (var e = [], r = 0; r < t.pairs.length; r++) {
                var a = t.pairs[r];
                e.push(k.pair(a.key, this.acceptNode(a.value), a.loc));
              }
              return k.hash(e, t.loc);
            }
          },
          {
            key: "StringLiteral",
            value: function(t) {
              return k.literal("StringLiteral", t.value, t.loc);
            }
          },
          {
            key: "BooleanLiteral",
            value: function(t) {
              return k.literal("BooleanLiteral", t.value, t.loc);
            }
          },
          {
            key: "NumberLiteral",
            value: function(t) {
              return k.literal("NumberLiteral", t.value, t.loc);
            }
          },
          {
            key: "UndefinedLiteral",
            value: function(t) {
              return k.literal("UndefinedLiteral", void 0, t.loc);
            }
          },
          {
            key: "NullLiteral",
            value: function(t) {
              return k.literal("NullLiteral", null, t.loc);
            }
          }
        ]),
        e
  ...
  function $(t, e) {
    return {
      ...
      params: e.params
        ...
        : [],
      hash: e.hash ? t.Hash(e.hash) : k.hash()
    };
  }
  function F(t, e) {
    var r = e.path,
    ...
    var l = k.elementModifier(r, a, n, i);
    t.modifiers.push(l);
  }
  function G(t, e) {
  ...
  function Q(t, e, r) {
    return new J("Cannot remove a node unless it is part of an array", t, e, r);
  }
  function W(t, e, r) {
    return new J(
  ...
  function Y(t, e) {
    ...
    if (
      (a && a.enter && (r = a.enter.call(null, e)), void 0 !== r && null !== r)
    ) {
      if (JSON.stringify(e) !== JSON.stringify(r))
        return Array.isArray(r) ? tt(t, r) || r : Y(t, r) || r;
      r = void 0;
    }
    if (void 0 === r) {
      for (var n = K[e.type], i = 0; i < n.length; i++) X(t, a, e, n[i]);
  ...
  function X(t, e, r, a) {
    ...
    if (n) {
      ...
      if (i && i.enter && void 0 !== i.enter.call(null, r, a)) throw Z(r, a);
      if (Array.isArray(n)) tt(t, n);
      else {
        var s = Y(t, n);
        void 0 !== s &&
          (function(t, e, r) {
            if (null === r) throw Q(t[e], t, e);
            if (Array.isArray(r)) {
              if (1 !== r.length)
                throw 0 === r.length ? Q(t[e], t, e) : W(t[e], t, e);
              t[e] = r[0];
            } else t[e] = r;
          })(r, a, s);
      }
      if (i && i.exit && void 0 !== i.exit.call(null, r, a)) throw Z(r, a);
    }
  }
  function tt(t, e) {
    for (var r = 0; r < e.length; r++) {
      var a = Y(t, e[r]);
      void 0 !== a && (r += et(e, r, a) - 1);
    }
  }
  function et(t, e, r) {
    return null === r
  ...
  function at(t) {
    ...
    switch (t.type) {
      case "Program":
        ...
        a && (a.chained = !0);
        var n = nt(t.body).join("");
        r.push(n);
        break;
      case "ElementNode":
        r.push("<", t.tag),
          t.attributes.length && r.push(" ", nt(t.attributes).join(" ")),
          t.modifiers.length && r.push(" ", nt(t.modifiers).join(" ")),
          t.comments.length && r.push(" ", nt(t.comments).join(" ")),
          r.push(">"),
          r.push.apply(r, nt(t.children)),
          r.push("</", t.tag, ">");
        break;
      case "AttrNode":
        r.push(t.name, "=");
      ...
      case "ConcatStatement":
        r.push('"'),
          t.parts.forEach(function(t) {
            "StringLiteral" === t.type ? r.push(t.original) : r.push(at(t));
          }),
          r.push('"');
        break;
      case "TextNode":
      ...
      case "BlockStatement":
        ...
        t.chained
          ...
          s.push(at(t.program)),
          t.inverse &&
            (t.inverse.chained || s.push("{{else}}"), s.push(at(t.inverse))),
          t.chained ||
            s.push(
              (function(t) {
                return ["{{/", at(t.path), "}}"].join("");
              })(t)
            ),
          r.push(s.join(""));
        break;
      ...
      case "Hash":
        ...
        break;
      case "HashPair":
        r.push("".concat(t.key, "=").concat(at(t.value)));
    }
    return r.join("");
  }
  function nt(t) {
  ...
  function it(t) {
    ...
    switch (t.type) {
      ...
      case "ElementModifierStatement":
      case "BlockStatement":
        if (h(t.path)) return String(t.path.value);
        e = at(t.path);
        break;
      case "PartialStatement":
        e = at(t.name);
    ...
    return st([e, nt(t.params).join(" "), at(t.hash)], " ");
  }
  function st(t, e) {
    return (function(t) {
      var e = [];
        ...
        t.registerHelper("blockHelperMissing", function(e, r) {
          ...
          if (pt.isArray(e))
            return e.length > 0
              ...
              : a(this);
          if (r.data && r.ids) {
            var i = pt.createFrame(r.data);
            (i.contextPath = pt.appendContextPath(r.data.contextPath, r.name)),
              (r = { data: i });
          }
          return n(e, r);
        });
  ...
  ut(dt);
  var mt = ht(function(t, r) {
    r.__esModule = !0;
    var a,
      n = (a = ft) && a.__esModule ? a : { default: a };
      ...
      t.registerHelper("each", function(t, r) {
        ...
        function u(e, r, n) {
          l &&
            ...
            (o += a(t[e], {
              data: l,
              blockParams: pt.blockParams([t[e], e], [c + e, null])
            }));
        }
        if (
          (r.data &&
            r.ids &&
            (c = pt.appendContextPath(r.data.contextPath, r.ids[0]) + "."),
          pt.isFunction(t) && (t = t.call(this)),
          r.data && (l = pt.createFrame(r.data)),
          t && "object" === e(t))
        )
          if (pt.isArray(t))
  ...
  ut(mt);
  var gt = ht(function(t, e) {
    e.__esModule = !0;
    var r,
      a = (r = ft) && r.__esModule ? r : { default: r };
    (e.default = function(t) {
  ...
  ut(gt);
  var vt = ht(function(t, e) {
    (e.__esModule = !0),
      (e.default = function(t) {
        t.registerHelper("if", function(t, e) {
          return (
            pt.isFunction(t) && (t = t.call(this)),
            (!e.hash.includeZero && !t) || pt.isEmpty(t)
              ? e.inverse(this)
              : e.fn(this)
          );
        }),
  ...
  ut(yt);
  var kt = ht(function(t, e) {
    (e.__esModule = !0),
      (e.default = function(t) {
        t.registerHelper("with", function(t, e) {
          pt.isFunction(t) && (t = t.call(this));
          var r = e.fn;
          if (pt.isEmpty(t)) return e.inverse(this);
          var a = e.data;
          return (
            e.data &&
              e.ids &&
              ((a = pt.createFrame(e.data)).contextPath = pt.appendContextPath(
                e.data.contextPath,
                e.ids[0]
              )),
            r(t, {
              data: a,
              blockParams: pt.blockParams([t], [a && a.contextPath])
            })
          );
        });
      }),
        ...
        t.registerDecorator("inline", function(t, e, r, a) {
          ...
          return (
            e.partials ||
              ...
              (n = function(a, n) {
                var i = r.partials;
                r.partials = pt.extend({}, i, e.partials);
                var s = t(a, n);
  ...
  var Et = ht(function(t, e) {
    ...
    var r = {
      ...
      lookupLevel: function(t) {
        if ("string" == typeof t) {
          var e = pt.indexOf(r.methodMap, t.toLowerCase());
  ...
  var Pt = ht(function(t, e) {
    ...
    function i(t, e, r) {
      (this.helpers = t || {}),
        (this.partials = e || {}),
        (this.decorators = r || {}),
        St.registerDefaultHelpers(this),
        xt.registerDefaultDecorators(this);
    }
    i.prototype = {
      constructor: i,
      logger: n.default,
    ...
    var s = n.default.log;
    (e.log = s), (e.createFrame = pt.createFrame), (e.logger = n.default);
  });
  ut(Pt);
  ...
  ut(At);
  var Lt = ht(function(t, r) {
    (r.__esModule = !0),
      (r.checkRevision = function(t) {
        var e = (t && t[0]) || 1,
          r = Pt.COMPILER_REVISION;
        if (e !== r) {
          if (e < r) {
            var a = Pt.REVISION_CHANGES[r],
              n = Pt.REVISION_CHANGES[e];
            throw new i.default(
    ...
    var a,
      ...
      i = (a = ft) && a.__esModule ? a : { default: a };
  ...
  ut(Lt);
  var Nt = ht(function(t, e) {
    (e.__esModule = !0),
      (e.default = function(t) {
        var e = void 0 !== ct ? ct : window,
          r = e.Handlebars;
  ...
  ut(qt);
  var Tt = ht(function(t, e) {
    e.__esModule = !0;
    var r,
      a = (r = qt) && r.__esModule ? r : { default: r };
    function n() {
      var t =
  ...
  var It = ht(function(t, e) {
    ...
    (e.__esModule = !0),
      ...
      (e.compile = function(t, e, r) {
        ...
        "data" in (e = pt.extend({}, e)) || (e.data = !0);
        e.compat && (e.useDepths = !0);
        var n = void 0;
        function i() {
          var a = r.parse(t, e),
    ...
    function o(t, e) {
      if (t === e) return !0;
      if (pt.isArray(t) && pt.isArray(e) && t.length === e.length) {
  ...
  var Rt = ht(function(t, e) {
    ...
    r ||
      ((r = function(t, e, r, a) {
        ...
        add: function(t) {
          pt.isArray(t) && (t = t.join("")), (this.src += t);
        },
        prepend: function(t) {
          pt.isArray(t) && (t = t.join("")), (this.src = t + this.src);
        },
  ...
  var Vt = ht(function(t, e) {
    ...
    (s.prototype = {
      nameLookup: function(t, e) {
        return s.isValidJavaScriptVariableName(e)
          ? [t, ".", e]
          : [t, "[", JSON.stringify(e), "]"];
      },
      ...
      compilerInfo: function() {
        var t = Pt.COMPILER_REVISION;
        return [t, Pt.REVISION_CHANGES[t]];
      },
    ...
    function c() {
      ...
      return (
        (t.compile = function(e, r) {
          return It.compile(e, r, t);
        }),
        (t.precompile = function(e, r) {
          return It.precompile(e, r, t);
        }),
        (t.AST = n.default),
        (t.Compiler = It.Compiler),
  ...
  ut(Mt);
  var jt = {},
    zt = Object.freeze({ default: jt }),
    Ut = (zt && jt) || zt,
    $t = Ht.default;
  ($t.PrintVisitor = Mt.PrintVisitor), ($t.print = Mt.print);
  var Ft = $t;
  function Gt(t, e) {
    var r = Ut.readFileSync(e, "utf8");
    t.exports = $t.compile(r);
  }
  "undefined" != typeof require &&
    require.extensions &&
    ((require.extensions[".handlebars"] = Gt),
    (require.extensions[".hbs"] = Gt));
  var Kt = Ft.parse,
    ...
    return (
      ...
      n(e, [
        ...
        },
        {
          key: "beginComment",
          value: function() {
            (this.currentNode = k.comment("")),
              (this.currentNode.loc = {
                source: null,
                start: k.pos(this.tagOpenLine, this.tagOpenColumn),
                end: null
              });
          }
        },
        ...
        },
        {
          key: "finishComment",
          value: function() {
            (this.currentComment.loc.end = k.pos(
              this.tokenizer.line,
              this.tokenizer.column
            )),
              P(this.currentElement(), this.currentComment);
          }
        },
        {
          key: "beginData",
          value: function() {
            (this.currentNode = k.text()),
              (this.currentNode.loc = {
                source: null,
                start: k.pos(this.tokenizer.line, this.tokenizer.column),
                end: null
              });
          }
        },
        ...
        },
        {
          key: "finishData",
          value: function() {
            (this.currentData.loc.end = k.pos(
              this.tokenizer.line,
              this.tokenizer.column
            )),
              P(this.currentElement(), this.currentData);
          }
        },
        {
          key: "tagOpen",
        ...
        },
        {
          ...
          value: function() {
            var t = this.tokenizer,
              ...
              r = t.column,
              a = this.currentTag;
            (a.loc = k.loc(this.tagOpenLine, this.tagOpenColumn, e, r)),
              "StartTag" === a.type
                ? (this.finishStartTag(),
                  (Jt[a.name] || a.selfClosing) && this.finishEndTag(!0))
        ...
        },
        {
          ...
          value: function() {
            var t = this.currentStartTag,
              ...
              a = t.modifiers,
              n = t.comments,
              i = k.loc(this.tagOpenLine, this.tagOpenColumn),
              s = k.element(e, r, a, [], n, i);
          ...
          value: function(t) {
            ...
            !(function(t, e, r) {
              ...
              Jt[t.name] && !r
                ...
                : void 0 === e.tag
                ? (a = "Closing tag " + Wt(t) + " without an open tag.")
                : e.tag !== t.name &&
                  (a =
                    "Closing tag " +
                    Wt(t) +
          ...
          value: function() {
            var t = this.currentAttr,
              ...
              o = (function(t, e, r, a) {
                ...
                return t.length > 0 ? t[0] : k.text("");
              })(r, a, n, this.tokenizer.line);
            o.loc = k.loc(i, s, this.tokenizer.line, this.tokenizer.column);
            var l = k.loc(
          ...
          value: function(t) {
            throw new w(
              "Syntax error at line "
                ...
                .concat(t),
              k.loc(this.tokenizer.line, this.tokenizer.column)
            );
          }
        }
      ]),
  ...
  var Zt = { parse: Yt, builders: k, print: at, traverse: rt, Walker: ot };
  function Yt(t, r) {
    var a = "object" === e(t) ? t : Kt(t),
      n = new Qt(t, r).acceptNode(a);
    if (r && r.plugins && r.plugins.ast)
      for (var i = 0, s = r.plugins.ast.length; i < s; i++) {
        rt(
          n,
          (0, r.plugins.ast[i])(M({}, r, { syntax: Zt }, { plugins: void 0 }))
            .visitor
        );
      }
    return n;
  ...
  var Xt = Object.freeze({
    ...
    cannotRemoveNode: Q,
    cannotReplaceNode: W,
    cannotReplaceOrRemoveInKeyHandlerYet: Z,
    traverse: rt,
    Walker: ot,
    print: at,
    SyntaxError: w,
  ...
  function ee() {
    return {
      visitor: {
        Program: function(t) {
          t.body = t.body.filter(te);
        },
        ElementNode: function(t) {
          t.children = t.children.filter(te);
        }
      }
    };
  }
  return {
    parsers: {
      glimmer: {
        parse: function(e) {
          try {
            return (0, Xt.preprocess)(e, { plugins: { ast: [ee] } });
          } catch (e) {
