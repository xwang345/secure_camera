...
var dbURI =
  "mongodb://xwang345:Aoiwxc93!@ds151463.mlab.com:51463/home_security";
      ...
      bcrypt.genSalt(10, function(err, salt) {
        ...
        bcrypt.hash(userData.password, salt, function(err, hash) {
          ...
          newUser
            ...
            .then(err => {
              console.log(
                chalk.blue("===   Object is saving in the database.  ===")
              );
              console.log(
                chalk.blue("============================================")
              );
              ...
              console.log(
                chalk.blue(
                  "This is User object id from userSchema: " + newUser._id
                )
              );
...
module.exports.checkUser = userData => {
  ...
  return new Promise((resolve, reject) => {
    Comment.find({ user: userData.user })
      .exec()
      .then(user => {
        ...
        if (user == null) {
          ...
          bcrypt.compare(userData.password, hash, (err, valid) => {
            ...
            if (valid == true) {
              ...
              reject(
                "The current password is worry for user: " + userData.user
              );
            }
          });
        }
